...
const LogicalProgramming: NextPage = () => {
  return (
    <footer className="self-stretch bg-white box-border flex flex-col items-start justify-start pt-[77px] px-[129px] pb-[30px] gap-[64px] max-w-full text-left text-5xl text-black font-red-hat-text border-[1px] border-solid border-whitesmoke-200 mq450:gap-[16px] mq900:gap-[32px] mq900:pt-[50px] mq900:px-8 mq900:pb-5 mq900:box-border mq1275:pl-16 mq1275:pr-16 mq1275:box-border">
      ...
      <div className="w-[1638px] flex flex-row items-start justify-start py-0 px-1 box-border max-w-full text-darkslategray-200">
        <div className="flex-1 flex flex-col items-start justify-start gap-[47px] max-w-full mq900:gap-[23px]">
          <div className="self-stretch flex flex-row items-start justify-start py-0 pr-0 pl-0.5 box-border max-w-full">
            <div className="flex-1 flex flex-col items-start justify-start gap-[41px] max-w-full mq900:gap-[20px]">
              ...
              <h3 className="m-0 self-stretch relative text-inherit font-normal font-inherit z-[1] mq450:text-lgi">{`Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. `}</h3>
            </div>
          </div>
          <div className="self-stretch h-px relative box-border z-[1] border-t-[1px] border-solid border-whitesmoke-200" />
        </div>
      </div>
      <div className="flex flex-row items-start justify-start py-0 px-1 box-border max-w-full font-red-hat-display">
        <div className="flex flex-row items-start justify-start gap-[43.3px] max-w-full z-[1] mq1600:flex-wrap mq900:gap-[22px]">
          ...
          <h3 className="m-0 w-[197px] relative text-inherit font-normal font-inherit inline-block shrink-0 mq450:text-lgi">
            School Education
          </h3>
          <h3 className="m-0 relative text-inherit font-normal font-inherit inline-block min-w-[66px] mq450:text-lgi">
            News
          </h3>
          <h3 className="m-0 w-[92px] relative text-inherit font-normal font-inherit inline-block shrink-0 mq450:text-lgi">
            Events
          </h3>
          <h3 className="m-0 w-[92px] relative text-inherit font-normal font-inherit inline-block shrink-0 mq450:text-lgi">
            Blogs
      ...
      <div className="w-[513px] h-[66.9px] relative hidden max-w-full" />
    </footer>
  );
};
