...
const LogicGate: NextPage = () => {
  return (
    <header className="mr-[-1px] self-stretch bg-white box-border flex flex-row items-start justify-between py-0 pr-0.5 pl-[134px] top-[0] z-[99] sticky gap-[20px] max-w-full text-left text-mini text-black font-red-hat-display border-[1px] border-solid border-whitesmoke mq900:pl-[33px] mq900:box-border mq1275:pl-[67px] mq1275:box-border">
      ...
      <div className="w-[1161px] flex flex-col items-start justify-start max-w-full">
        <div className="self-stretch box-border flex flex-row items-start justify-center pt-3.5 pb-3 pr-5 pl-[187px] gap-[53px] max-w-full z-[1] border-b-[1px] border-solid border-whitesmoke mq1275:pl-[93px] mq1275:box-border mq450:gap-[53px_26px] mq450:pl-[46px] mq450:box-border">
        ...
        <div className="flex flex-row items-end justify-start py-0 pr-5 pl-0 box-border gap-[52px] max-w-full mq900:gap-[52px_26px]">
          <div className="w-[746px] flex flex-col items-start justify-end pt-0 px-0 pb-5 box-border max-w-full">
            <div className="self-stretch flex flex-row items-start justify-between pt-0 pb-1 pr-1 pl-0 gap-[20px] z-[1]">
              ...
              <div className="flex flex-row items-start justify-start py-0 pr-[11.800000000000182px] pl-0 gap-[9.199999999999818px]">
