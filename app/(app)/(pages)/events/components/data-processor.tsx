...
const DataProcessor: NextPage = () => {
  return (
    <section className="mr-[-1px] self-stretch bg-white box-border flex flex-col items-start justify-start pt-[77px] px-[129px] pb-[30px] gap-[41px] max-w-full text-left text-5xl text-black font-red-hat-text border-[1px] border-solid border-whitesmoke mq900:gap-[20px_41px] mq900:pt-[50px] mq900:px-8 mq900:pb-5 mq900:box-border mq1275:pl-16 mq1275:pr-16 mq1275:box-border">
      <div className="w-[1920px] h-[582px] relative bg-white box-border hidden max-w-full border-t-[1px] border-solid border-whitesmoke" />
      ...
      <div className="w-[1638px] flex flex-row items-start justify-start pt-0 px-1 pb-[23px] box-border max-w-full text-darkslategray">
        <div className="flex-1 flex flex-col items-start justify-start gap-[47px] max-w-full mq900:gap-[23px_47px]">
          <div className="self-stretch flex flex-row items-start justify-start py-0 pr-0 pl-0.5 box-border max-w-full">
            <h2 className="m-0 flex-1 relative text-inherit font-normal font-inherit inline-block max-w-full z-[1] mq450:text-lgi">{`Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. `}</h2>
          </div>
          <div className="self-stretch h-px relative box-border z-[1] border-t-[1px] border-solid border-whitesmoke" />
        </div>
      </div>
      <div className="flex flex-row items-start justify-start pt-0 px-1 pb-[23px] box-border max-w-full font-red-hat-display">
        <div className="flex flex-row items-start justify-start gap-[43.285714285714285px] max-w-full z-[1] mq900:gap-[43.3px_22px] mq1600:flex-wrap">
          ...
          <h2 className="m-0 w-[197px] relative text-inherit font-normal font-inherit inline-block shrink-0 mq450:text-lgi">
            School Education
          </h2>
          <h2 className="m-0 relative text-inherit font-normal font-inherit inline-block min-w-[66px] mq450:text-lgi">
            News
          </h2>
          <h2 className="m-0 w-[92px] relative text-inherit font-normal font-inherit inline-block shrink-0 mq450:text-lgi">
            Events
          </h2>
          <h2 className="m-0 w-[92px] relative text-inherit font-normal font-inherit inline-block shrink-0 mq450:text-lgi">
            Blogs
      ...
      <div className="w-[1625px] flex flex-col items-end justify-start gap-[25px] max-w-full text-xl">
        ...
        <div className="self-stretch flex flex-row items-start justify-between max-w-full gap-[20px] mq1275:flex-wrap">
          ...
          <div className="w-[487px] flex flex-row items-start justify-start gap-[56.5px] max-w-full z-[1] text-xl-9 font-red-hat-display mq900:flex-wrap mq900:gap-[56.5px_28px]">
