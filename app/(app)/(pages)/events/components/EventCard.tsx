...
export type FrameComponent2Type = {
  ...
  propDebugCommit?: any | CSSProperties;
  propWidth?: any;
  propHeight?: any;
  propDebugCommit1?: any;
};

const EventCardComponent: NextPage<FrameComponent2Type> = ({
  vector2,
  vector4,
  propDebugCommit,
  propWidth,
  ...
  return (
    <div className="w-full flex flex-row items-start justify-start py-0 px-[26px] box-border max-w-full">
      <div className="flex-1 flex flex-col items-start justify-start gap-[35px] max-w-full mq900:gap-[17px_35px]">
        <div className="self-stretch flex flex-col items-start justify-start gap-[19.299999999999955px] max-w-full text-left text-mini text-black font-red-hat-text">
          <div className="w-full flex flex-col items-start justify-start gap-[14.5px] max-w-full">
            <div
