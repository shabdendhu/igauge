  ...
  return (
    <header className="self-stretch bg-white box-border flex flex-row items-start justify-between py-0 pr-0.5 pl-[134px] top-[0] z-[99] sticky gap-[20px] max-w-full text-left text-mini text-black font-red-hat-display border-[1px] border-solid border-whitesmoke mq900:pl-[33px] mq900:box-border mq1300:pl-[67px] mq1300:box-border">
      ...
      <div className="w-[1161px] flex flex-col items-start justify-start max-w-full">
        <div className="self-stretch box-border flex flex-row items-start justify-center pt-3.5 pb-3 pr-5 pl-[187px] gap-[53px] max-w-full z-[1] border-b-[1px] border-solid border-whitesmoke mq1300:pl-[93px] mq1300:box-border mq450:gap-[26px] mq450:pl-[46px] mq450:box-border">
          <nav className="m-0 w-[515px] flex flex-col items-start justify-start pt-px px-0 pb-0 box-border max-w-full mq900:w-0 mq1650:hidden">
        ...
        <div className="flex flex-row items-end justify-start py-0 pr-5 pl-0 box-border gap-[52px] max-w-full mq900:gap-[26px]">
          ...
          <button className="cursor-pointer [border:none] py-[23px] pr-[34px] pl-[35px] bg-orange-100 flex flex-row items-start justify-start gap-[9px] whitespace-nowrap z-[1] hover:bg-chocolate">
            <img
