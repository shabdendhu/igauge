...
const ErrorHandler: FunctionComponent = () => {
  return (
    <section className="self-stretch bg-white box-border flex flex-col items-start justify-start pt-[77px] px-[129px] pb-[30px] gap-[41px] max-w-full text-left text-5xl text-black font-red-hat-text border-[1px] border-solid border-whitesmoke mq900:gap-[20px] mq900:pt-[50px] mq900:px-8 mq900:pb-5 mq900:box-border mq1300:pl-16 mq1300:pr-16 mq1300:box-border">
      <div className="w-full h-[582px] relative bg-white box-border hidden max-w-full border-t-[1px] border-solid border-whitesmoke" />
      ...
      <div className="flex flex-row items-start justify-start pt-0 px-1 pb-[23px] box-border max-w-full font-red-hat-display">
        <div className="flex flex-row items-start justify-start gap-[43.3px] max-w-full z-[1] mq900:gap-[22px] mq1650:flex-wrap">
      ...
      <div className="w-[1625px] flex flex-col items-end justify-start gap-[25px] max-w-full text-xl">
        <div className="self-stretch h-px relative box-border z-[1] border-t-[1px] border-solid border-whitesmoke" />
        <div className="self-stretch flex flex-row items-start justify-between max-w-full gap-[20px] mq1300:flex-wrap">
