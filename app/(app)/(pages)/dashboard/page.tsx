...
const Dashboard: NextPage = () => {
  return (
    <div className="px-6 md:px-20 bg-white overflow-hidden flex flex-col items-start justify-start md:px-[150px]">
      ...
      {/* </section> */}
      <div className="grid grid-cols-1 md:grid-cols-2 md:flex-row w-full pt-8 gap-9 mt-3">
